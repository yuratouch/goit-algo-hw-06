...
# Додавання ребер з вагами (маршрути між станціями) Кожне ребро отримує вагу. 
# В даному прикладі всі ваги встановлені рівними 2, крім пересадочних вузлів, які мають вагу 1.
edges = [("Академмістечко", "Житомирська", 2), ("Житомирська", "Святошин", 2), ("Святошин", "Нивки", 2), 
         ...
         ("Театральна", "Хрещатик", 1), ("Хрещатик", "Арсенальна", 2), ("Арсенальна", "Дніпро", 2), 
         ("Дніпро", "Гідропарк", 2), ("Гідропарк", "Лівобережна", 2), ("Лівобережна", "Дарниця", 2), 
         ("Дарниця", "Чернігівська", 2), ("Чернігівська", "Лісова", 2), ("Героїв Дніпра", "Мінська", 2), 
         ("Мінська", "Оболонь", 2), ("Оболонь", "Почайна", 2), ("Почайна", "Тараса Шевченка", 2), 
         ("Тараса Шевченка", "Контрактова площа", 2), ("Контрактова площа", "Поштова площа", 2), 
         ("Поштова площа", "Майдан Незалежності", 2), ("Майдан Незалежності", "Хрещатик", 1), 
         ...
         ("Іподром", "Теремки", 2), ("Сирець", "Дорогожичі", 2), ("Дорогожичі", "Лук'янівська", 2), 
         ("Лук'янівська", "Золоті ворота", 2), ("Золоті ворота", "Театральна", 1), ("Палац Спорту", "Кловська", 2), 
...
for source in shortest_paths:
    for target in shortest_paths[source]:
        print(f"Найкоротший шлях від {source} до {target}: {shortest_paths[source][target]} з довжиною {shortest_paths_length[source][target]}")
